...
import { HourSelect } from "./HourFields";
...
export default function ManualEntryWizard({ request, onClose, onSaved, initial }: Props) {
  ...
  return (
      <AccessibleDialog className="booking-dialog manual-entry-dialog" labelledBy="manual-entry-title" onClose={onClose} initialFocusSelector="input:not([disabled]), select:not([disabled]), button:not(.dialog-close)">
